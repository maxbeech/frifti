...
export default function Disclosure() {
  return (
    <div className="mx-auto max-w-2xl space-y-4">
      <h1 className="text-3xl font-bold text-slate-900">Affiliate &amp; advertising disclosure</h1>
      <p className="text-sm text-slate-400">Last updated 30 June 2026</p>
      <div className="space-y-4 text-slate-700">
        ...
        <ul className="list-disc space-y-2 pl-5">
          <li>
            <strong>Optional one-time products.</strong> Our <Link href="/premium" className="text-emerald-700 underline">Claim Kit and Estate Claim Report</Link> are
